...
import app.simov.taximetroimos.activities.MainActivity;
import app.simov.taximetroimos.includes.MyToolbar;
import app.simov.taximetroimos.providers.AuthProvider;
import app.simov.taximetroimos.providers.GeofireProvider;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Detener o iniciar la Hubicacion del Usuario
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Intevarlo de actualizacion del Usuario en el mapa
        mLocationRequest.setInterval(1000);
        mLocationRequest.setFastestInterval(1000);
        //Utilizar el GPS con la Mayor presicion posible
    ...
    //Mensaje si no Esta activo EL GPS
    ...
    //Cuano el Usuario no acepta Los permisos.
    ...
    //Llamamos amenu de appbarDriver
    @Override
